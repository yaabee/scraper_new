...
offset = 1700
while 1:
    url = f'https://www.hwk-konstanz.de/betriebe/suche-64,0,bdbsearch.html?limit=50&search-searchterm=&search-job=&search-local=&search-filter-zipcode=*&search-filter-radius=20&search-filter-jobnr=&search-filter-experience=&offset={offset}'
    ...
    for link in filtered_links:
        single_page = requests.get('https://www.hwk-konstanz.de' + link)
