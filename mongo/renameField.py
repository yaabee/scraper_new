...
def rename_field(db_name, col_name, field_name_old, field_name_new):
    ...
    # update = collection.update({}, {"$rename": {field_name_old: field_name_new}}, False, True)
...
if __name__ == "__main__":
    rename_field(db_name="scrp_listen", col_name="lithonplus", field_name_old="Homepage", field_name_new="Internet")
